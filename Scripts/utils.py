...
def runInitialExploration(dataFolder,dataInd=4):
    ...
    dataExp.loadDataSample(fileSet[dataInd],colSet[dataInd])
    dataExp.convertDataCat()
    tempResults = dataExp.temporalAnalysis()
